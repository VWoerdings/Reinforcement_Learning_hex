...
if __name__ == '__main__':
    ...
    # c=0.5 player
    n1 = NNetWrapper(game)
    n1.load_checkpoint('./trained_networks/', 'c0_5_10iter.pth.tar')
    mcts1 = MCTS(game, n1, args)
    n1p = alphazero_move(mcts1, BOARD_SIZE)  # This is the move generating function
    alphazero_description1 = "Alphazero player (C=0.5)"

    # c=1 player
    n2 = NNetWrapper(game)
    n2.load_checkpoint('./trained_networks/', 'c1_10iter.pth.tar')
    mcts2 = MCTS(game, n2, args)
    n2p = alphazero_move(mcts2, BOARD_SIZE)  # This is the move generating function
    alphazero_description2 = "Alphazero player (C=1)"
    ...
    player3_description = alphazero_description3
